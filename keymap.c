...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [EXT_NAV_LAYER] = KEYMAP_ISO(
    _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, KC_PGUP,  _______, _______, _______, _______, _______, KC_INS,  _______, _______, _______, _______, \
  ...
  [INTERNAL_LAYER] = KEYMAP_ISO(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, KC_BTN1, KC_MS_U, KC_BTN2, _______, _______, _______, _______, _______, _______, _______, BL_DEC,  BL_INC, \
    _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______, KC_WH_U, KC_BTN3, KC_WH_D, _______, _______, NKRO_TOGG, _______, _______, _______, _______, _______, \
    _______, _______, _______,                      _______,                        _______, _______, _______, _______
  )
};
